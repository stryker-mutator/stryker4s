...
import stryker4jvm.reporting.{FinishedRunEvent, IOReporter, MutantTestedEvent}
import stryker4jvm.reporting.reporters.{AggregateReporter, ConsoleReporter}
import stryker4jvm.scalatest.LogMatchers
import stryker4jvm.testutil.{MockitoIOSuite, Stryker4jvmIOSuite}

class AggregateReporterTest extends Stryker4jvmIOSuite with MockitoIOSuite with LogMatchers {
...
//      val reporter1 = mock[IOReporter[Config]]
//      val reporter2 = mock[IOReporter[Config]]
...
//      val failingReporter = mock[IOReporter[Config]]
//      val reporter2 = mock[IOReporter[Config]]
