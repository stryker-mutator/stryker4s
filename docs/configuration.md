...
Valid values are Scala-versions without a patch version (`scala2.12`, `212`, `2.12`, `2`). The full list can be found [here](https://github.com/stryker-mutator/stryker4s/blob/master/core/src/main/scala/stryker4s/config/pure/ConfigConfigReader.scala#L79-L84).
