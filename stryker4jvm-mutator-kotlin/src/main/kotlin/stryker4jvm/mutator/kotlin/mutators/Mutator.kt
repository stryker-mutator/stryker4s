...
abstract class Mutator<T> where T : KtElement {
  ...
  /**
   * Function that should return a list which provides the possible mutations of the provided
   * element.
   */
  abstract fun mutateElement(original: KtElement): List<KtElement>

  /**
   * Returns a map of which the key is the original KtElement and the value is the list of possible
   * mutations
   */
