...
class DashboardConfigProviderTest extends Stryker4sSuite {
  ...
  test("resolveConfig should resolve a Travis environment") {
  ...
  test("resolveConfig should resolve a CircleCI environment") {
    implicit val config: Config = Config.default
    implicit val env: Env[Id] = EnvStub.makeEnv[Id](
      ("STRYKER_DASHBOARD_API_KEY", "apiKeyHere"),
      ("CIRCLECI", "true"),
  ...
  test("resolveConfig should resolve a GitHub actions environment") {
    implicit val config: Config = Config.default
    implicit val env: Env[Id] = EnvStub.makeEnv[Id](
      "STRYKER_DASHBOARD_API_KEY" -> "apiKeyHere",
      "GITHUB_ACTION" -> "true",
  ...
  test("resolveConfig should resolve a GitHub actions PR environment") {
    implicit val config: Config = Config.default
    implicit val env: Env[Id] = EnvStub.makeEnv[Id](
      "STRYKER_DASHBOARD_API_KEY" -> "apiKeyHere",
      "GITHUB_ACTION" -> "true",
  ...
  test("resolveConfig should resolve a configured environment") {
  ...
  test("resolveConfig should resolve without a module") {
    implicit val config: Config = Config.default.copy(
      dashboard = Config.default.dashboard.copy(
        project = "projectHere".some,
        version = "versionHere".some,
  ...
  test("resolveConfig should not resolve a GitHub actions with malformed ref") {
    implicit val config: Config = Config.default
    implicit val env: Env[Id] = EnvStub.makeEnv[Id](
      ("STRYKER_DASHBOARD_API_KEY", "apiKeyHere"),
      ("GITHUB_ACTION", "true"),
  ...
  test("resolveConfig should not resolve empty env variables") {
    implicit val config: Config = Config.default
    implicit val env: Env[Id] = EnvStub.makeEnv[Id](
      ("STRYKER_DASHBOARD_API_KEY", "apiKeyHere"),
      ("CIRCLECI", "true"),
  ...
  test("resolveConfig should not resolve when there is no STRYKER_DASHBOARD_API_KEY environment") {
    implicit val config: Config = Config.default.copy(
      dashboard = Config.default.dashboard.copy(
        project = "projectHere".some,
        version = "versionHere".some,
  ...
  test("resolveConfig should not resolve when there is no project") {
    implicit val config: Config = Config.default.copy(
      dashboard = Config.default.dashboard.copy(
        project = none,
        version = "versionHere".some,
  ...
  test("resolveConfig should not resolve when there is no version") {
    implicit val config: Config = Config.default.copy(
      dashboard = Config.default.dashboard.copy(
        project = "projectHere".some,
        version = none,
  ...
  test("resolveConfig should return all unresolved") {
    implicit val config: Config = Config.default.copy(
      dashboard = Config.default.dashboard.copy(
        project = none,
        version = none,
