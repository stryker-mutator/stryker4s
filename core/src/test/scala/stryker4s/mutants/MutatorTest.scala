  ...
  describe("logs") {
    it("should log the amount of mutants found") {
      ...
      sut.mutate(files).asserting { _ =>
        "Found 1 file(s) to be mutated." shouldBe loggedAsInfo
        "Found 1 file(s) to be mutated. Of which" should not be loggedAsInfo
    ...
    it("should log a warning if no mutants are found") {
      ...
      sut.mutate(files).asserting { _ =>
        "Found 0 file(s) to be mutated." shouldBe loggedAsInfo
