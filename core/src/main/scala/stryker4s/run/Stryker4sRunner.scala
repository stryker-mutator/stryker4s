...
import stryker4s.report.{CombinedReporter, ConsoleReporter, FinishedRunReporter, ProgressReporter}
...
trait Stryker4sRunner {
  ...
  def combineReporters()(implicit config: Config): CombinedReporter =
