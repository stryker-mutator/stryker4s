...
/**
 * Generic configuration used for all language-specific mutators which allows for customisation of
 * some mutator properties.
 */
public class LanguageMutatorConfig {
  ...
  /**
   * Retrieves the dialect of the configuration. The dialect should indicate the version of the
  ...
  /**
   * Retrieves the set of excluded mutations. Any mutator name that is in this set should not be
   * used by the language-specific mutator.
   *
