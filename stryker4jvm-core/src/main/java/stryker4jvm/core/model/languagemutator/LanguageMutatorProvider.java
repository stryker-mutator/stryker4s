...
public interface LanguageMutatorProvider {
  /**
   * Factory method that should return a mutator that is constrained by the config and instrumenter
   * options.
   *
   ...
   */
  LanguageMutator<?> provideMutator(
      LanguageMutatorConfig config, Logger logger, InstrumenterOptions instrumenterOptions)
      throws LanguageMutatorProviderException;
}
